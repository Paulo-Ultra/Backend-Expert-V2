...
public record CreateOrderRequest(
        @Schema(description = "Requester ID", example = "68120acf07820b17387a074f")
        ...
        @Schema(description = "Customer ID", example = "68120acf07820b17387a074f")
        ...
        @Size(min = 4, max = 15, message = "The description must be between 4 and 15 characters")
        String status
) {}
